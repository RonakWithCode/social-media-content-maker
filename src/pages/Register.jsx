    ...
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                <h1 className="mb-6 text-2xl font-semibold text-red-600 dark:red-600">{databaseError}</h1>
                <form  className="space-y-4 md:space-y-6" ref={registerForm} onSubmit={handleFormSubmit}>
                    <div>
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                            <label htmlFor="terms" className="font-light text-gray-900 dark:text-gray-300">I accept the <Link className="font-medium text-blue-600 hover:text-blue-800 visited:text-purple-600 hover:underline " href="#">Terms and Conditions</Link></label>
                        </div>
                    </div>
                    ...
                    <p className="text-sm font-light text-gray-900 dark:text-gray-400">
                        Already have an account? <Link to="/login" className="font-medium text-blue-600 hover
:text-blue-800 visited:text-purple-600 hover:underline ">Login here</Link>
                    </p>
                </form>
            </div>
        </div>
